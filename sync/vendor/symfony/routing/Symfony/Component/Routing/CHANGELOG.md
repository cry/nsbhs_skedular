 ...
 * [BC BREAK] RouteCollection does not behave like a tree structure anymore but as
   ...
   ```php
   $redactedCollection = new RouteCollection();
   $subCollection = new RouteCollection();
   $redactedCollection->addCollection($subCollection);
   ...
   $redactedCollection->addCollection($childCollection);
   ```
 ...
 * [BC BREAK] the UrlMatcher urldecodes the route parameters only once, they
   ...
   paths.
 * added RouteCollection::getRoot method to retrieve the redacted of a
